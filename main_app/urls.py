...
urlpatterns = [
  ...
  path('pokemons/<int:pokemon_id_id>/add_feeding/', views.add_feeding, name='add_feeding'),
  path('pokemons/<int:pokemon_id_id>/assoc_toy/<int:toy_id>/', views.assoc_toy, name='assoc_toy'),
